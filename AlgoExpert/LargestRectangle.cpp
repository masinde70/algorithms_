 ...
 *
 * For example, given buildings = [2, 1, 2], the area of the largest rectangle that can be created is 3, using all three buildings.
 * Since the minimum height of the three buildings is 1, you can create a rectangle that has height
